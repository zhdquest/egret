...
var GameScene = (function (_super) {
    ...
    GameScene.prototype.createPlayer = function () {
        var playerShape = new p2.Box({ width: 30, height: 30 });
    ...
    GameScene.prototype.createThings = function () {
        ...
        var contactMaterialAB = new p2.ContactMaterial(materialA, this.materialB);
        var contactMaterialBB = new p2.ContactMaterial(this.materialB, this.materialB);
